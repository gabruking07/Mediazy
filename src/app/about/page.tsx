...
export const metadata: Metadata = {
  title: "About",
  description: "About Mediazy and Aurex Technologies.",
    ...
    <MarketingShell>
      <main className="mx-auto max-w-4xl px-4 py-14 sm:px-6">
        ...
        <p className="mt-6 text-lg leading-8 text-muted-foreground">
          Mediazy is proudly developed by Aurex Technologies, a software company focused on building modern digital products, AI solutions, SaaS platforms, and web applications for creators, developers, businesses, and startups.
        </p>
        <section className="mt-12 rounded-lg border border-border bg-card p-6">
          <h2 className="text-2xl font-semibold tracking-tight">About Aurex Technologies</h2>
          <p className="mt-4 leading-8 text-muted-foreground">
            Aurex Technologies is an Indian software company dedicated to building innovative digital products, AI-powered applications, SaaS platforms, and custom software solutions. Our mission is to simplify technology through fast, reliable, and user-friendly products that empower creators, developers, businesses, and startups worldwide.
          </p>
        </section>
      </main>
    </MarketingShell>
