...
import type { CategoryMeta, ToolModule } from "@/shared/tools/types";
import { Base64Tool } from "@/client/tools/developer/base64-tool";
import { JsonFormatterTool } from "@/client/tools/developer/json-formatter-tool";
import { JwtDecoderTool } from "@/client/tools/developer/jwt-decoder-tool";
import { UuidGeneratorTool } from "@/client/tools/developer/uuid-generator-tool";
import { ImageCompressorTool } from "@/client/tools/image/image-compressor-tool";
import { ImageConverterTool } from "@/client/tools/image/image-converter-tool";
import { ImageResizerTool } from "@/client/tools/image/image-resizer-tool";
import { PdfUtilityTool } from "@/client/tools/pdf/pdf-utility-tool";
import { TextCaseTool } from "@/client/tools/text/text-case-tool";
import { PasswordGeneratorTool } from "@/client/tools/utility/password-generator-tool";
import { QrGeneratorTool } from "@/client/tools/utility/qr-generator-tool";
